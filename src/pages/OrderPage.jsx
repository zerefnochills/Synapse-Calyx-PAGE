              ...
              <div className={styles.stepPanel}>
                ...
                <div className={styles.formRow}>
                  <Field label="Full Name" required>
                    <input className={styles.input} placeholder="Your Full Name" value={form.fullName} onChange={e => update('fullName', e.target.value)} />
                  </Field>
                ...
                <div className={styles.formRow}>
                  <Field label="Phone Number">
                    <input className={styles.input} placeholder="+91 xxxxxxxxxx" value={form.phone} onChange={e => update('phone', e.target.value)} />
                  </Field>
              ...
              <div className={styles.stepPanel}>
                ...
                <div className={styles.formRow}>
                  <Field label="Company / Organization">
                    <input className={styles.input} placeholder="Your Company / Organization" value={form.company} onChange={e => update('company', e.target.value)} />
                  </Field>
                  <Field label="Your Position / Role">
                    <input className={styles.input} placeholder="Your Position / Role" value={form.position} onChange={e => update('position', e.target.value)} />
                  </Field>
                </div>
              ...
              <div className={styles.stepPanel}>
                ...
                <Field label="Budget Range (INR)" required>
                  <div className={styles.rangeLabels}>
                    <span>500</span><span>1500</span><span>5000</span><span>10000+</span>
                  </div>
